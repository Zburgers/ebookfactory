...
- Provider boundary: only endpoint/protocol/model metadata and a credential reference are persisted; provider URLs containing userinfo are rejected; provider GET responses expose only a boolean credential-configured state
