...
> Superseded correction (2026-09-19): the 5 MiB wording in the historical
> packet below described the earlier local gate and must not be read as the
> current KDP limit. Revision `104511c` changed the exporter and current
> guidance to the under-50 MB KDP ceiling; see
> `evidence/P08/manual-qa-2026-09-19.md` for the reconciliation evidence.
...
- At the time of this historical packet, cover preflight recorded
  `checks.cover_file_size: true` and used a 5 MiB local gate. The generated
  cover in this evidence packet was well below that earlier ceiling.
