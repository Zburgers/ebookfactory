...
- Cover preflight now also records `checks.cover_file_size: true` and fails the
  structural state when the marketing cover exceeds 5 MiB, matching the
  current KDP cover guidance. The generated cover in this evidence packet is
