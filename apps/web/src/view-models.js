  ...
  const stages = [
    {
      key: "brief",
      label: "Brief",
      description: "Promise, audience and constraints",
    ...
    },
    {
      key: "outline",
      label: "Outline",
      description: "A durable structure for the book",
    ...
    },
    {
      key: "draft",
      label: "Draft",
      description: "Sections assembled into a manuscript",
    ...
    },
    {
      key: "review",
      label: "Review",
      description: "Quality findings and owner inspection",
    ...
    },
    {
      key: "art",
      label: "Artwork",
      description: "Cover and source image decisions",
    ...
    },
    {
      key: "export",
      label: "Export",
      description: "Validated EPUB, PDF, DOCX and source files",
    ...
    },
    {
      ...
      description: "The final human publishing decision",
